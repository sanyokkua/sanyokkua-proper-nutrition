...
public class ProductsController {
  ...
  @GetMapping("/products")
  public List<Product> getAllProductsLike(@RequestParam(value = "name") String name) {
    Product[] products = new Product[] { new Product(11, "Apple", 100), new Product(1, "Cheeze", 100), new Product(2, "Pineapple", 21), new Product(3, "Toast", 10), new Product(4, "Strawberry", 108),
    ...
    return allProducts.stream().filter(product -> product.getName().startsWith(name)).collect(Collectors.toList());
  }
